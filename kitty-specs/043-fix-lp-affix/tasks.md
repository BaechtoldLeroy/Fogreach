...
- [ ] T001 — In `js/inventory.js`, in the stat-recompute path around line 869: read `LootSystem.getBonus('hp')` defensively (matching the pattern at `js/player.js:653`) and add it to `newMaxHealth`. Single hunk, ~3 lines added.
