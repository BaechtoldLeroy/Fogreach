...
(function() {
  ...
  if (window.i18n) {
    window.i18n.register('de', {
      ...
      'event.fountain.outcome.speed_buff': 'Eile! +20% Lauftempo bis Run-Ende.',
      ...
      'event.fountain.outcome.speed_debuff':'Schwer! -10% Lauftempo bis Run-Ende.',
    ...
    window.i18n.register('en', {
      ...
      'event.fountain.outcome.speed_buff': 'Haste! +20% move speed for the rest of the run.',
      ...
      'event.fountain.outcome.speed_debuff':'Heavy! -10% move speed for the rest of the run.',
